...
$string['months'] = 'Meses';
$string['timeintervals'] = 'Intervalos de tiempo';
$string['timeintervals_help'] = 'Lista de intervalos de tiempo separados por comas (,) para verificar la inactividad de los usuarios en el curso.';
