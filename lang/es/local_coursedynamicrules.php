...
$string['no_course_access_condition_info'] = 'Esta condición verificará qué usuarios no han accedido a este curso en el período de tiempo especificado.';
$string['no_course_access'] = 'Sin acceso al curso';
$string['no_course_access_description'] = 'Usuarios que no han accedido a este curso en los ultimos {$a->periodvalue} {$a->periodunit}';
