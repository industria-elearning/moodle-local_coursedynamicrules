...
$string['date_from_enrollment'] = 'Desde a data de matrícula';
...
$string['course_inactivity_custom_description'] = 'Usuários sem atividade no curso por intervalos de {$a->intervals} {$a->unit} desde {$a->basedate}';
$string['course_inactivity_recurring_description'] = 'Usuários sem atividade no curso em intervalos recorrentes de {$a->intervals} {$a->unit} desde {$a->basedate}';
