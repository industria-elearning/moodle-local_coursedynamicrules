...
Você pode ativar/desativar nas <a href="{$a}" target="_blank">Configurações de notificação</a> e procurar <strong>Notificação de regras dinâmicas do curso</strong>.
<br>
