...
$string['editrulecontent'] = 'Edit rule content';
$string['editruledetails'] = 'Edit rule details';
...
$string['messageprovider:smart_rules_ai_notification'] = 'Smart Rules AI OLD notification';
...
$string['pluginname'] = 'Smart Rules AI OLD';
...
$string['conditionadded'] = 'Condition added: {$a}';
$string['conditionnotsaved'] = 'The condition has not been saved yet';
$string['editcondition'] = 'Edit condition, {$a}';
$string['noconditions'] = 'There are no conditions for this rule';
$string['weeks'] = 'Weeks';
